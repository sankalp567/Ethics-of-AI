...
def main():
    ...
    model.proj = nn.Linear(576,512).to(device)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        torch.save(
            ckpt,
            f"{Config.CHECKPOINT_DIR}/studentmnsmall_kd_fd2_A_epoch_{epoch+1}.pth"
        )
        ...
        if val_rob_acc > best_rob_acc:
            ...
            torch.save(
                checkpoint,
                os.path.join(Config.CHECKPOINT_DIR, 'MobileNetSmall_studentmnsmall_kd_fd2_A_best.pth')
            )
