...
def main():
    ...
    print("Initializing ResNetSmall teacherres34A Model...")
    ...
    ckp_path = os.path.join(Config.CHECKPOINT_DIR, 'ResNetSmall_teacherres34A_best.pth')
    ...
    print(f"Starting Pre-training of ResNetSmall (teacherres34A) from epoch {start_epoch+1} to {args.epochs}...")
    for epoch in range(start_epoch, args.epochs):
        ...
        torch.save(
            ckpt,
            f"{Config.CHECKPOINT_DIR}/teacherres34A_epoch_{epoch+1}.pth"
        )
        ...
        if val_rob_acc > best_rob_acc:
            ...
            torch.save(
                checkpoint,
                os.path.join(Config.CHECKPOINT_DIR, 'ResNetSmall_teacherres34A_best.pth')
            )
